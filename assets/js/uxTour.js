...
var tour = {
  steps: [
    {element: 'uxStep1', text: 'Wide range of uber cool clipart to choose from.', direction: 'top'},
    {element: 'uxStep2', text: 'Independence to color the clipart as per your choice.', direction: 'top'},
    {element: 'uxStep3', text: 'Type whatever you feel like.', direction: 'top'}
  ]
};
...
// start the tour when the page loads
  $("#kdsslider").on('slid.bs.carousel', function(){
    uxStart();
  });
